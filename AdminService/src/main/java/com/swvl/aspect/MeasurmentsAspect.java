...
@Order(0)
@Component
public class MeasurmentsAspect {

    Logger log = LoggerFactory.getLogger(MeasurmentsAspect.class);

    @Around(value = "execution(* com.swvl..service..*(..))")
